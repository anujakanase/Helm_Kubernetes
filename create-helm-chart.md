...
1. **Create a new GitHub repository:**
   ...
   * Name: `Helm_Kubernetes`

2. **Initialize a Git repo:**

   ```bash
   git init
   git remote add origin https://github.com/anujakanase/Helm_Kubernetes.git
   ```
...
1. **Add the Helm repo:**
   ...
   ```bash
   helm repo add myrepo https://anujakanase.github.io/Helm_Kubernetes
   helm repo update
   ```
